...
export default class Television extends React.Component {
    ...
    loadQuestion() {
        ...
        if (data1['Questions']['Redirects'] < 4) {
            ...
            browserHistory.push('/Television')
        }
        else if (data1['Questions']['Redirects'] >= 3) {
            console.log('tre')
            data1['Questions']['Redirects'] = 0;
    ...
    componentWillMount() {
        ...
        firebase.database().ref('UserInfo/').on('value', (data) => {
            ...
            let Question = data1['Questions']['Television']['Quiz1'][que]['Question'];
            let op1 = data1['Questions']['Television']['Quiz1'][que]['Answer'];
            let op2 = data1['Questions']['Television']['Quiz1'][que]['Answer3'];
            let op3 = data1['Questions']['Television']['Quiz1'][que]['Answer2'];
            let op4 = data1['Questions']['Television']['Quiz1'][que]['Answer4'];
            let Ans = data1['Questions']['Television']['Quiz1'][que]['Correct Answer'];
